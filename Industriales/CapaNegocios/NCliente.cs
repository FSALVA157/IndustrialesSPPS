...
namespace CapaNegocios
{
    ...
    {//inicio de clase
        ...
        public static string Insertar(int id_cliente, int dni, int legajo, string apellido, string nombre, string telefono, string direccion, string email, int personal, int habilitado, string fecha_nac, int localidad, decimal monto_alcance, int cuenta_bancaria, byte[] foto, int id_tipo_cliente, int id_sexo, string textobuscar)
        {
        ...
        public static string Editar(int id_cliente, int dni, int legajo, string apellido, string nombre, string telefono, string direccion, string email, int personal, int habilitado, string fecha_nac, int localidad, decimal monto_alcance, int cuenta_bancaria, byte[] foto, int id_tipo_cliente, int id_sexo)
        {
            DCliente Obj = new DCliente();
            Obj.Id_cliente = id_cliente;
            Obj.Dni = dni;
